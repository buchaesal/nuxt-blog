    ...
    section.featured-posts
      article.post-preview
        nuxt-link(:to="'/posts/'+1")
          figure.post-thumbnail(style="background-image: url(//images.unsplash.com/photo-1571372183175-bbe560b1603a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1351&q=80)")
          .post-content
            h2.post-title 포스트 제목 1
            p.post-text 포스트 내용
      article.post-preview
        nuxt-link(:to="'/posts/'+2")
          figure.post-thumbnail(style="background-image: url(//images.unsplash.com/photo-1571372183175-bbe560b1603a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1351&q=80)")
          .post-content
            h2.post-title 포스트 제목 2
            p.post-text 포스트 내용
</template>
